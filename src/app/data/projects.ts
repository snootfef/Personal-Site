...
const projects: Array<ProjectProps> = [
   { name: 'delingu.com', description: 'A personal website/portfolio, all about me.', img: 'gradient2.jpg', tools: 'TypeScript, Tailwind, CSS, React, Next.js', date: 'February 2024' },
